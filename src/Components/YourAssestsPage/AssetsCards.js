...
export class AssetsCards extends Component {
  ...
  handelDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:3001/house/${id}/test2@gmail.com`)
      .then((result) => {
        this.setState({
  ...
  handelSubmite = (e) => {
    ...
    axios
      .put(`http://localhost:3001/house/${id}/test2@gmail.com`, obj)
      .then((result) => {
        this.setState({
          housesArr: result.data,
        });
              ...
              <Col>
                <div className="services">
                  <div id="serv_hover" className="services_box">
                    ...
                    <button onClick={() => this.handelShow(ele)}>
                      Edit House
                    </button>
                    <button
                      onClick={() => {
                        this.handelDelete(ele._id);
                      }}
                    >
                      {" "}
                      Delet House
