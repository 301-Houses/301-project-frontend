        ...
        <Modal.Body>
          <form className="assetsForm" onSubmit={this.props.handelSubmite}>
            ...
            <input
              ...
              id="imgURL"
              name="imgURL"
              defaultValue={this.props.modalData.imgURL}
            ></input>
            ...
            <input
              ...
              id="ownerName"
              name="ownerName"
              defaultValue={this.props.modalData.ownerName}
            ></input>
            ...
            <input
              ...
              id="houseAddress"
              name="houseAddress"
              defaultValue={this.props.modalData.houseAddress}
            ></input>
            ...
            <input
              ...
              id="houseSize"
              name="houseSize"
              defaultValue={this.props.modalData.houseSize}
            ></input>
            ...
            <input
              ...
              id="numOfRoomse"
              name="numOfRoomse"
              defaultValue={this.props.modalData.numOfRoomse}
            ></input>
            ...
            <input
              ...
              id="price"
              name="price"
              defaultValue={this.props.modalData.price}
            ></input>
            ...
            <input
              ...
              id="phoneNumber"
              name="phoneNumber"
              defaultValue={this.props.modalData.phoneNumber}
            ></input>
            <div className="rido">
